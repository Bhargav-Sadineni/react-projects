      ...
      <section className="relative w-full h-screen bg-white dark:bg-black overflow-hidden">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-20">
          ...
          <div className="relative max-w-5xl mx-auto mb-16">
            ...
            >
              <div className="absolute -inset-4 bg-gradient-to-r from-purple-600 to-pink-600 rounded-3xl blur-xl opacity-30 group-hover:opacity-50 transition-opacity" />
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-4xl mx-auto">
            <div className="text-center p-6 bg-gray-50 dark:bg-zinc-900 rounded-xl">
              ...
              <p className="text-gray-600 dark:text-gray-400 text-sm">Sub-second response times guaranteed</p>
            </div>
            ...
            <div className="text-center p-6 bg-gray-50 dark:bg-zinc-900 rounded-xl">
              ...
              <p className="text-gray-600 dark:text-gray-400 text-sm">SOC 2 Type II certified protection</p>
            </div>
            ...
            <div className="text-center p-6 bg-gray-50 dark:bg-zinc-900 rounded-xl">
              ...
              <p className="text-gray-600 dark:text-gray-400 text-sm">Smart automation that learns</p>
            </div>
          </div>
        </div>
      </section>
